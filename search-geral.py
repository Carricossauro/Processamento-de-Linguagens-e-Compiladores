...
#print("Linhas que contém uma STRING entre aspas")
#busca(r'\".*\"')
...
#print("This time your phone number should not have an area code - only the three digit, dash, four digit local phone number")
#busca(r'(^|\s)[0-9]{3}-[0-9]{4}')

# 12. Last, allow your phone number to be seven consecutive digits as well as the three digit dash four digit type.
print("Allow your phone number to be seven consecutive digits as well as the three digit dash four digit type")
busca(r'[0-9]{3}(-)?[0-9]{4}')